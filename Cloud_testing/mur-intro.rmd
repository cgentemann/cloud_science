...
authors: "Chelle Gentemann, Aimee Barciauskas, Mike Chin"
Gentemann and Barciauskas put the JPL MUR SST into Zarr format for distribution on AWS Public Dataset Program.  Mike Chin is PI of the JPL MUR SST dataset distributed by the NASA PO.DAAC.
...
MUR SST data v4.1 are currently provided in Zarr data format, these are easy to open with the Xarray software tool.
...
This variable is the sea_ice concentration from NSIDC.
...
To cite use of this dataset: AWS Public Dataset Program.  JPL MUR MEaSUREs Project. 2015. GHRSST Level 4 MUR Global Foundation Sea Surface Temperature Analysis (v4.1). Ver. 4.1. PO.DAAC, CA, USA.  Data accessed at AWS. https://doi.org/10.5067/GHGMR-4FJ04.